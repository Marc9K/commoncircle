...
const sampleEvents: Record<string, EventDetailData> = {
  "1": {
    id: 1,
...
This is a beginner-friendly event - whether you're just starting your tech journey or you're an experienced professional, everyone is welcome.

No agenda, no pressure - just good company and interesting conversations about technology, careers, and the local tech scene.

Feel free to bring business cards or any projects you'd like to share!`,
    organizer: {
      name: "Birmingham Tech Meetup",
      email: "hello@birminghamtech.org",
    },
    capacity: 25,
    registeredCount: 12,
    isRegistered: false,
    communityId: 3,
    communityName: "Birmingham Tech Community",
  },
};
